export const IPC = {
	...
	CONNECTION_GET_RECENT: "connection:getRecent",
	CONNECTION_MARK_RECENT: "connection:markRecent",
	FILE_LIST: "file:list",
	...
	FILE_CREATE_FILE: "file:createFile",
	...
	REMOTE_CREATE_FILE: "remote:createFile",
	REMOTE_CHMOD: "remote:chmod",
	REMOTE_CHOWN: "remote:chown",
	REMOTE_LIST_USERS: "remote:listUsers",
	REMOTE_LIST_GROUPS: "remote:listGroups",
	...
	FILE_COLUMNS_GET: "fileColumns:get",
	FILE_COLUMNS_SET: "fileColumns:set",
	...
	CONNECTION_SELECT_KEY_FILE: "connection:selectKeyFile",
	APP_OPEN_CONNECTION: "app:openConnection",
	APP_GET_PENDING_CONNECTION: "app:getPendingConnection",
