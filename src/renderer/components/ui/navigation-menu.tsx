...
const navigationMenuTriggerStyle = cva(
	`
		group/navigation-menu-trigger inline-flex h-9 w-max items-center justify-center rounded-lg px-2.5 py-1.5 text-sm
			...
			<NavigationMenuPrimitive.Positioner
				...
				className={cn(
					`
						...
						data-[side=bottom]:before:inset-x-0 data-[side=bottom]:before:-top-2.5
					`,
					className,
				)}
				{...props}
			>
				<NavigationMenuPrimitive.Popup
					className="
						...
						transition-[opacity,transform,width,height,scale,translate] duration-[0.35s]
