				...
				<ComboboxPrimitive.Popup
					...
					className={cn(
						`
							...
							min-w-[calc(var(--anchor-width)+(--spacing(7)))] origin-(--transform-origin) overflow-hidden rounded-lg
...
function ComboboxItem({ className, children, ...props }: ComboboxPrimitive.Item.Props) {
	return (
		<ComboboxPrimitive.Item
			...
			className={cn(
				`
					relative flex w-full cursor-default items-center gap-2 rounded-md py-1 pr-8 pl-1.5 text-sm outline-hidden
					select-none
...
function ComboboxChips({
	...
	return (
		<ComboboxPrimitive.Chips
			...
			className={cn(
				`
					flex min-h-8 flex-wrap items-center gap-1 rounded-lg border border-input bg-transparent bg-clip-padding px-2.5
