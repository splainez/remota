	...
	return (
		<AlertDialogPortal>
			...
			<AlertDialogPrimitive.Popup
				...
				className={cn(
					`
						group/alert-dialog-content fixed top-1/2 left-1/2 z-50 grid w-full -translate-1/2 gap-4 rounded-xl
						bg-popover p-4 text-popover-foreground ring-1 ring-foreground/10 duration-100 outline-none
						data-[size=default]:max-w-xs
						data-[size=sm]:max-w-xs
						sm:data-[size=default]:max-w-sm
