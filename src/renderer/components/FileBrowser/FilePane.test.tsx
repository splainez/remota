...
const mockApi = createMockApi({
	...
	filesystem: {
		...
		createFile: vi.fn<() => Promise<void>>().mockResolvedValue(undefined),
		...
		remoteMkdir: vi.fn<() => Promise<void>>().mockResolvedValue(undefined),
		remoteCreateFile: vi.fn<() => Promise<void>>().mockResolvedValue(undefined),
		remoteChmod: vi.fn<() => Promise<void>>().mockResolvedValue(undefined),
		remoteChown: vi.fn<() => Promise<void>>().mockResolvedValue(undefined),
